...
public:
	...
	*/
	...
	virtual double setTxGain(double db, size_t chan) override {OSMO_ASSERT(false); return 0.0f; }
	virtual double getTxGain(size_t chan = 0) override { OSMO_ASSERT(false); return 0.0f; };
	virtual double maxTxGain(void) override { OSMO_ASSERT(false); return 0.0f; };
